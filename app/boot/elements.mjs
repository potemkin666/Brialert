export function createElements() {
  return {
    ...
    auditLastRefresh: document.getElementById('audit-last-refresh'),
    auditSourceCount: document.getElementById('audit-source-count'),
    auditLastRestore: document.getElementById('audit-last-restore'),
